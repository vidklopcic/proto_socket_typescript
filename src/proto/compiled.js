...
export const sfiles = ($root.sfiles = (() => {
  ...
  sfiles.UploadStartSlot = (function () {
    ...
    UploadStartSlot.decode = function decode(reader, length) {
      ...
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.UploadStartSlot();
    ...
    UploadStartSlot.verify = function verify(message) {
      ...
      if (message.localKey != null && message.hasOwnProperty('localKey'))
        if (!$util.isString(message.localKey)) return 'localKey: string expected';
      return null;
    };
    ...
    UploadStartSlot.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.UploadStartSlot) return object;
      let message = new $root.sfiles.UploadStartSlot();
      if (object.key != null) message.key = String(object.key);
      if (object.localKey != null) message.localKey = String(object.localKey);
      return message;
    };
    ...
    UploadStartSlot.toObject = function toObject(message, options) {
      ...
      if (message.localKey != null && message.hasOwnProperty('localKey')) object.localKey = message.localKey;
      return object;
    };
  ...
  sfiles.UploadProgress = (function () {
    ...
    UploadProgress.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.UploadProgress();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UploadProgress.verify = function verify(message) {
      ...
      if (message.nBytes != null && message.hasOwnProperty('nBytes'))
        if (
          !$util.isInteger(message.nBytes) &&
          !(message.nBytes && $util.isInteger(message.nBytes.low) && $util.isInteger(message.nBytes.high))
        )
    ...
    UploadProgress.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.UploadProgress) return object;
      let message = new $root.sfiles.UploadProgress();
      if (object.nBytes != null)
        if ($util.Long) (message.nBytes = $util.Long.fromValue(object.nBytes)).unsigned = false;
        else if (typeof object.nBytes === 'string') message.nBytes = parseInt(object.nBytes, 10);
        else if (typeof object.nBytes === 'number') message.nBytes = object.nBytes;
    ...
    UploadProgress.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        ...
        } else object.nBytes = options.longs === String ? '0' : 0;
        object.key = '';
        object.localKey = '';
      }
      if (message.nBytes != null && message.hasOwnProperty('nBytes'))
        if (typeof message.nBytes === 'number')
          ...
          object.nBytes =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.nBytes)
              : options.longs === Number
              ? new $util.LongBits(message.nBytes.low >>> 0, message.nBytes.high >>> 0).toNumber()
              : message.nBytes;
      if (message.key != null && message.hasOwnProperty('key')) object.key = message.key;
      if (message.localKey != null && message.hasOwnProperty('localKey')) object.localKey = message.localKey;
      return object;
  ...
  sfiles.UploadDone = (function () {
    ...
    UploadDone.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.UploadDone();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UploadDone.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.UploadDone) return object;
      let message = new $root.sfiles.UploadDone();
      if (object.key != null) message.key = String(object.key);
      if (object.file != null) {
        if (typeof object.file !== 'object') throw TypeError('.sfiles.UploadDone.file: object expected');
  ...
  sfiles.UploadedFile = (function () {
    ...
    UploadedFile.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.UploadedFile();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UploadedFile.verify = function verify(message) {
      ...
      if (message.thumbUrl != null && message.hasOwnProperty('thumbUrl'))
        if (!$util.isString(message.thumbUrl)) return 'thumbUrl: string expected';
    ...
    UploadedFile.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.UploadedFile) return object;
  ...
  sfiles.UploadStart = (function () {
    ...
    UploadStart.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.UploadStart();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UploadStart.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.UploadStart) return object;
  ...
  sfiles.DeleteFile = (function () {
    ...
    DeleteFile.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.DeleteFile();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    DeleteFile.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.DeleteFile) return object;
      let message = new $root.sfiles.DeleteFile();
      if (object.file != null) {
        if (typeof object.file !== 'object') throw TypeError('.sfiles.DeleteFile.file: object expected');
        message.file = $root.sfiles.UploadedFile.fromObject(object.file);
      }
      return message;
    };
  ...
  sfiles.UploadEnd = (function () {
    ...
    UploadEnd.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sfiles.UploadEnd();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
    ...
    UploadEnd.fromObject = function fromObject(object) {
      if (object instanceof $root.sfiles.UploadEnd) return object;
...
export const socket_api = ($root.socket_api = (() => {
  ...
  socket_api.Ack = (function () {
    ...
    Ack.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.socket_api.Ack();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    Ack.verify = function verify(message) {
      ...
      if (message.asyncProgressKey != null && message.hasOwnProperty('asyncProgressKey'))
        if (!$util.isString(message.asyncProgressKey)) return 'asyncProgressKey: string expected';
    ...
    Ack.fromObject = function fromObject(object) {
      if (object instanceof $root.socket_api.Ack) return object;
      ...
      if (object.asyncProgressKey != null) message.asyncProgressKey = String(object.asyncProgressKey);
  ...
  socket_api.AsyncProgress = (function () {
    ...
    AsyncProgress.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.socket_api.AsyncProgress();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    AsyncProgress.verify = function verify(message) {
      ...
      if (message.done != null && message.hasOwnProperty('done'))
        if (typeof message.done !== 'boolean') return 'done: boolean expected';
      if (message.errorMessage != null && message.hasOwnProperty('errorMessage'))
        if (!$util.isString(message.errorMessage)) return 'errorMessage: string expected';
      return null;
    };
    ...
    AsyncProgress.fromObject = function fromObject(object) {
      if (object instanceof $root.socket_api.AsyncProgress) return object;
  ...
  socket_api.UpgradeApiVersion = (function () {
    ...
    UpgradeApiVersion.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.socket_api.UpgradeApiVersion();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UpgradeApiVersion.verify = function verify(message) {
      ...
      if (message.latest != null && message.hasOwnProperty('latest'))
        if (!$util.isInteger(message.latest)) return 'latest: integer expected';
      return null;
    };
    ...
    UpgradeApiVersion.fromObject = function fromObject(object) {
      if (object instanceof $root.socket_api.UpgradeApiVersion) return object;
      let message = new $root.socket_api.UpgradeApiVersion();
      if (object.latest != null) message.latest = object.latest | 0;
      return message;
    };
    ...
    UpgradeApiVersion.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.defaults) object.latest = 0;
      if (message.latest != null && message.hasOwnProperty('latest')) object.latest = message.latest;
      return object;
    };
...
export const authentication = ($root.authentication = (() => {
  ...
  authentication.LoginToken = (function () {
    ...
    LoginToken.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.authentication.LoginToken();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    LoginToken.verify = function verify(message) {
      ...
      if (message.refresh != null && message.hasOwnProperty('refresh'))
        if (!$util.isString(message.refresh)) return 'refresh: string expected';
      return null;
    };
    ...
    LoginToken.fromObject = function fromObject(object) {
      if (object instanceof $root.authentication.LoginToken) return object;
      let message = new $root.authentication.LoginToken();
      if (object.token != null) message.token = String(object.token);
      if (object.refresh != null) message.refresh = String(object.refresh);
      return message;
    };
    ...
    LoginToken.toObject = function toObject(message, options) {
      ...
      if (message.refresh != null && message.hasOwnProperty('refresh')) object.refresh = message.refresh;
      return object;
    };
  ...
  authentication.LoginError = (function () {
    ...
    LoginError.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.authentication.LoginError();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    LoginError.verify = function verify(message) {
      ...
      if (message.errorText != null && message.hasOwnProperty('errorText'))
        if (!$util.isString(message.errorText)) return 'errorText: string expected';
      if (message.errorCode != null && message.hasOwnProperty('errorCode'))
    ...
    LoginError.fromObject = function fromObject(object) {
      if (object instanceof $root.authentication.LoginError) return object;
      let message = new $root.authentication.LoginError();
      if (object.errorText != null) message.errorText = String(object.errorText);
    ...
    LoginError.toObject = function toObject(message, options) {
      ...
      if (message.errorText != null && message.hasOwnProperty('errorText')) object.errorText = message.errorText;
      if (message.errorCode != null && message.hasOwnProperty('errorCode')) object.errorCode = message.errorCode;
      return object;
    };
  ...
  authentication.Login = (function () {
    ...
    Login.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.authentication.Login();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    Login.fromObject = function fromObject(object) {
      if (object instanceof $root.authentication.Login) return object;
  ...
  authentication.RefreshToken = (function () {
    ...
    RefreshToken.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.authentication.RefreshToken();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    RefreshToken.verify = function verify(message) {
      ...
      if (message.refreshToken != null && message.hasOwnProperty('refreshToken'))
        if (!$util.isString(message.refreshToken)) return 'refreshToken: string expected';
      return null;
    };
    ...
    RefreshToken.fromObject = function fromObject(object) {
      if (object instanceof $root.authentication.RefreshToken) return object;
      let message = new $root.authentication.RefreshToken();
      if (object.refreshToken != null) message.refreshToken = String(object.refreshToken);
      return message;
    };
    ...
    RefreshToken.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.defaults) object.refreshToken = '';
      if (message.refreshToken != null && message.hasOwnProperty('refreshToken'))
  ...
  authentication.VerifyToken = (function () {
    ...
    VerifyToken.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.authentication.VerifyToken();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
    ...
    VerifyToken.fromObject = function fromObject(object) {
      if (object instanceof $root.authentication.VerifyToken) return object;
  ...
  authentication.TokenInvalid = (function () {
    ...
    TokenInvalid.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.authentication.TokenInvalid();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
    ...
    TokenInvalid.fromObject = function fromObject(object) {
      if (object instanceof $root.authentication.TokenInvalid) return object;
...
export const uploader = ($root.uploader = (() => {
  ...
  uploader.UploadTask = (function () {
    ...
    UploadTask.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.uploader.UploadTask(),
        key,
        value;
      while (reader.pos < end) {
        let tag = reader.uint32();
    ...
    UploadTask.verify = function verify(message) {
      ...
      if (message.created != null && message.hasOwnProperty('created'))
        if (
          ...
          !(message.created && $util.isInteger(message.created.low) && $util.isInteger(message.created.high))
        )
      ...
      if (message.retryCounter != null && message.hasOwnProperty('retryCounter'))
        if (!$util.isInteger(message.retryCounter)) return 'retryCounter: integer expected';
      ...
      if (message.metadata != null && message.hasOwnProperty('metadata')) {
        ...
        for (let i = 0; i < key.length; ++i)
          if (!$util.isString(message.metadata[key[i]])) return 'metadata: string{k:string} expected';
      }
      return null;
    };
    ...
    UploadTask.fromObject = function fromObject(object) {
      if (object instanceof $root.uploader.UploadTask) return object;
      let message = new $root.uploader.UploadTask();
      if (object.created != null)
        if ($util.Long) (message.created = $util.Long.fromValue(object.created)).unsigned = true;
      ...
      if (object.retryCounter != null) message.retryCounter = object.retryCounter | 0;
      ...
      if (object.url != null) message.url = String(object.url);
      if (object.metadata) {
        if (typeof object.metadata !== 'object') throw TypeError('.uploader.UploadTask.metadata: object expected');
        message.metadata = {};
    ...
    UploadTask.toObject = function toObject(message, options) {
        ...
        if (typeof message.created === 'number')
          ...
          object.created =
            options.longs === String
              ...
              : options.longs === Number
              ? new $util.LongBits(message.created.low >>> 0, message.created.high >>> 0).toNumber(true)
              : message.created;
      ...
      if (message.status != null && message.hasOwnProperty('status'))
        object.status =
          options.enums === String
            ? $root.uploader.UploadStatus[message.status] === undefined
              ? message.status
              : $root.uploader.UploadStatus[message.status]
            : message.status;
      if (message.retryCounter != null && message.hasOwnProperty('retryCounter'))
      ...
      if (message.metadata && (keys2 = Object.keys(message.metadata)).length) {
        object.metadata = {};
        for (let j = 0; j < keys2.length; ++j) object.metadata[keys2[j]] = message.metadata[keys2[j]];
      }
      return object;
    };
  ...
  uploader.UploadUFile = (function () {
    ...
    UploadUFile.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.uploader.UploadUFile();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UploadUFile.verify = function verify(message) {
      ...
      if (message.fileId != null && message.hasOwnProperty('fileId'))
        if (!$util.isString(message.fileId)) return 'fileId: string expected';
    ...
    UploadUFile.fromObject = function fromObject(object) {
      if (object instanceof $root.uploader.UploadUFile) return object;
      let message = new $root.uploader.UploadUFile();
      if (object.fileId != null) message.fileId = String(object.fileId);
      if (object.task != null) {
        if (typeof object.task !== 'object') throw TypeError('.uploader.UploadUFile.task: object expected');
    ...
    UploadUFile.toObject = function toObject(message, options) {
      ...
      if (message.fileId != null && message.hasOwnProperty('fileId')) object.fileId = message.fileId;
      if (message.task != null && message.hasOwnProperty('task'))
  ...
  uploader.DeleteUFile = (function () {
    ...
    DeleteUFile.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.uploader.DeleteUFile();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    DeleteUFile.fromObject = function fromObject(object) {
      if (object instanceof $root.uploader.DeleteUFile) return object;
  ...
  uploader.UploadSlot = (function () {
    ...
    UploadSlot.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.uploader.UploadSlot(),
        key,
        value;
      while (reader.pos < end) {
        let tag = reader.uint32();
    ...
    UploadSlot.fromObject = function fromObject(object) {
      if (object instanceof $root.uploader.UploadSlot) return object;
      let message = new $root.uploader.UploadSlot();
      if (object.file != null) {
        if (typeof object.file !== 'object') throw TypeError('.uploader.UploadSlot.file: object expected');
        message.file = $root.uploader.UFile.fromObject(object.file);
      }
      if (object.metadata) {
        if (typeof object.metadata !== 'object') throw TypeError('.uploader.UploadSlot.metadata: object expected');
        message.metadata = {};
        for (let keys = Object.keys(object.metadata), i = 0; i < keys.length; ++i)
          message.metadata[keys[i]] = String(object.metadata[keys[i]]);
      }
  ...
  uploader.UFile = (function () {
    ...
    UFile.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.uploader.UFile();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    UFile.verify = function verify(message) {
      ...
      if (message.preview != null && message.hasOwnProperty('preview'))
        if (!$util.isString(message.preview)) return 'preview: string expected';
      if (message.previewLarge != null && message.hasOwnProperty('previewLarge'))
        if (!$util.isString(message.previewLarge)) return 'previewLarge: string expected';
      if (message.name != null && message.hasOwnProperty('name'))
        if (!$util.isString(message.name)) return 'name: string expected';
      if (message.uploadTask != null && message.hasOwnProperty('uploadTask'))
        if (!$util.isString(message.uploadTask)) return 'uploadTask: string expected';
      if (message.localPath != null && message.hasOwnProperty('localPath'))
        if (!$util.isString(message.localPath)) return 'localPath: string expected';
      return null;
    };
    ...
    UFile.fromObject = function fromObject(object) {
      if (object instanceof $root.uploader.UFile) return object;
      let message = new $root.uploader.UFile();
      if (object.id != null) message.id = String(object.id);
      if (object.src != null) message.src = String(object.src);
      if (object.preview != null) message.preview = String(object.preview);
      if (object.previewLarge != null) message.previewLarge = String(object.previewLarge);
      if (object.name != null) message.name = String(object.name);
      if (object.uploadTask != null) message.uploadTask = String(object.uploadTask);
      if (object.localPath != null) message.localPath = String(object.localPath);
      return message;
    };
    ...
    UFile.toObject = function toObject(message, options) {
      ...
      if (message.id != null && message.hasOwnProperty('id')) object.id = message.id;
      if (message.src != null && message.hasOwnProperty('src')) object.src = message.src;
      if (message.preview != null && message.hasOwnProperty('preview')) object.preview = message.preview;
      if (message.previewLarge != null && message.hasOwnProperty('previewLarge'))
        object.previewLarge = message.previewLarge;
      if (message.name != null && message.hasOwnProperty('name')) object.name = message.name;
      if (message.uploadTask != null && message.hasOwnProperty('uploadTask')) object.uploadTask = message.uploadTask;
      if (message.localPath != null && message.hasOwnProperty('localPath')) object.localPath = message.localPath;
      return object;
    };
